...
if __name__ == "__main__":
    ...
    parser.add_argument("--azure-endpoint", default="", help="Azure OpenAI endpoint (or set AZURE_OPENAI_ENDPOINT env var)")
    parser.add_argument("--azure-deployment", default="", help="Azure deployment name (defaults to --model)")
